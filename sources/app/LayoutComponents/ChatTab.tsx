...
<<<<<<< HEAD
                    <Avatar border={{motion:loading}} contentMotion={loading} style={{ color: '#f56a00'}}>A</Avatar>
=======
...
<<<<<<< HEAD
                    <Avatar border={{motion:false}} contentMotion={false} style={{ color: '#87d068'}}>Q</Avatar>
=======
...
<<<<<<< HEAD
                <TextArea disabled={promptDisabled} rows={9} onChange={handlePromptChange} value={prompt}/>
=======
